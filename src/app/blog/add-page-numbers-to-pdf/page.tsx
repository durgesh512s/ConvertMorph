...
const postData: BlogPostMetadata = {
  ...
  datePublished: '2025-01-17T10:00:00.000Z',
  dateModified: '2025-01-17T10:00:00.000Z',
...
export default function AddPageNumbersToPDFGuide() {  const breadcrumbJsonLd = {
    "@context": "https://schema.org",
    "@type": "BreadcrumbList",
    "@id": "https://convertmorph.com/blog/add-page-numbers-to-pdf#breadcrumb",
    "itemListElement": [
      { "@type": "ListItem", "position": 1, "name": "Home", "item": "https://convertmorph.com/" },
      { "@type": "ListItem", "position": 2, "name": "Blog", "item": "https://convertmorph.com/blog" },
      { "@type": "ListItem", "position": 3, "name": "Add Page Numbers to PDF Online - Free PDF Page Numbering Tool", "item": "https://convertmorph.com/blog/add-page-numbers-to-pdf" }
    ]
  };
              ...
              <article className="bg-white dark:bg-gray-800 rounded-xl shadow-sm border border-gray-200 dark:border-gray-700 p-4 sm:p-6 lg:p-8 w-full overflow-hidden">
                <header className="mb-6 lg:mb-8">
                  ...
                  <div className="flex items-center text-gray-600 dark:text-gray-400 text-xs sm:text-sm mb-4 lg:mb-6 flex-wrap gap-2 sm:gap-4">
                    <time dateTime={postData.datePublished}>January 17, 2025</time>
