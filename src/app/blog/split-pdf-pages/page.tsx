...
export default function SplitPDFGuide() {  const breadcrumbJsonLd = {
    "@context": "https://schema.org",
    "@type": "BreadcrumbList",
    "@id": "https://convertmorph.com/blog/split-pdf-pages#breadcrumb",
    "itemListElement": [
      { "@type": "ListItem", "position": 1, "name": "Home", "item": "https://convertmorph.com/" },
      { "@type": "ListItem", "position": 2, "name": "Blog", "item": "https://convertmorph.com/blog" },
      { "@type": "ListItem", "position": 3, "name": "How to Split PDF Pages: Extract & Separate PDF Files Online", "item": "https://convertmorph.com/blog/split-pdf-pages" }
    ]
  };
