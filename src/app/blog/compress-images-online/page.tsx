...
const breadcrumbs = [
  { name: 'Home', url: '/' },
  { name: 'Blog', url: '/blog' },
  { name: 'Compress Images Online', url: '/blog/compress-images-online' }
];
              ...
              {breadcrumbs.map((crumb, index) => (
                <li key={crumb.url} className="flex items-center">
                  ...
                  {index === breadcrumbs.length - 1 ? (
                    ...
                    <Link href={crumb.url} className="hover:text-purple-600 dark:hover:text-purple-400 transition-colors">
                      {crumb.name}
                    </Link>
                  )}
                </li>
