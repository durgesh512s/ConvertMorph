      ...
      <div className="min-h-screen bg-gradient-to-br from-rose-50 to-pink-100 dark:from-gray-900 dark:to-gray-800">
        <div className="container mx-auto px-4 py-8 sm:py-16">
          <div className="max-w-4xl mx-auto">
            ...
            {/* How to Use Section */}
            <div className="mt-16 sm:mt-20 bg-gradient-to-r from-blue-50 via-indigo-50 to-navy-50 dark:from-blue-900/20 dark:via-indigo-900/20 dark:to-gray-900/20 rounded-3xl p-8 sm:p-12 border border-blue-200 dark:border-blue-800">
              <div className="text-center mb-12">
