...
import { Type, Upload, Settings, Eye, Download, Palette, Move, Layers, Shield, Zap, Target, Sliders, CheckCircle, ArrowRight } from 'lucide-react'
            ...
            <div className="bg-white dark:bg-gray-800 rounded-xl p-8 shadow-lg mb-8">
              ...
              <div className="space-y-8">
                <div className="flex items-start space-x-4">
                  <div className="bg-gradient-to-r from-cyan-500 to-teal-600 text-white rounded-full w-10 h-10 flex items-center justify-center text-lg font-bold flex-shrink-0 mt-1">
                    1
                  </div>
                  <div>
                    <h4 className="text-xl font-semibold text-gray-900 dark:text-white mb-3">Upload and Prepare Your PDF</h4>
                    <p className="text-gray-600 dark:text-gray-300 mb-4">
                      Start by uploading your PDF document. The tool accepts files up to 100MB and automatically analyzes the document structure for optimal watermark placement.
                    </p>
                    <div className="bg-cyan-50 dark:bg-cyan-900/20 p-4 rounded-lg">
                      <p className="text-sm text-cyan-700 dark:text-cyan-300">
                        💡 <strong>Pro Tip:</strong> For best results, ensure your PDF has clear margins and readable content. The tool will automatically detect the best placement zones.
                      </p>
                    </div>
                  </div>
                </div>
                ...
                <div className="flex items-start space-x-4">
                  <div className="bg-gradient-to-r from-teal-500 to-cyan-600 text-white rounded-full w-10 h-10 flex items-center justify-center text-lg font-bold flex-shrink-0 mt-1">
                    2
                  </div>
                  <div>
                    <h4 className="text-xl font-semibold text-gray-900 dark:text-white mb-3">Create Your Watermark Text</h4>
                    <p className="text-gray-600 dark:text-gray-300 mb-4">
                      Enter your watermark text in the input field. This could be your company name, copyright notice, "CONFIDENTIAL" stamp, or any custom text you need.
                    </p>
                    <div className="grid grid-cols-1 md:grid-cols-2 gap-4 mt-3">
                      <div className="bg-teal-50 dark:bg-teal-900/20 p-3 rounded-lg">
                        <p className="text-sm text-teal-700 dark:text-teal-300">
                          <strong>Copyright:</strong> © 2024 Your Company Name
                        </p>
                      </div>
                      <div className="bg-cyan-50 dark:bg-cyan-900/20 p-3 rounded-lg">
                        <p className="text-sm text-cyan-700 dark:text-cyan-300">
                          <strong>Confidential:</strong> CONFIDENTIAL - DO NOT DISTRIBUTE
                        </p>
                      </div>
                    </div>
                  </div>
                ...
                <div className="flex items-start space-x-4">
                  <div className="bg-gradient-to-r from-blue-500 to-teal-600 text-white rounded-full w-10 h-10 flex items-center justify-center text-lg font-bold flex-shrink-0 mt-1">
                    3
                  </div>
                  <div>
                    <h4 className="text-xl font-semibold text-gray-900 dark:text-white mb-3">Configure Position and Style</h4>
                    <p className="text-gray-600 dark:text-gray-300 mb-4">
                      Choose the perfect position for your watermark. Select from preset positions or use custom coordinates for precise placement.
                    </p>
                    <div className="grid grid-cols-1 md:grid-cols-3 gap-4 mt-3">
                      <div className="bg-blue-50 dark:bg-blue-900/20 p-3 rounded-lg">
                        <h5 className="font-semibold text-blue-700 dark:text-blue-300 mb-1">Position Options</h5>
                        <p className="text-sm text-blue-600 dark:text-blue-400">
                          Center, corners, top/bottom, or custom coordinates
                        </p>
                      </div>
                      <div className="bg-teal-50 dark:bg-teal-900/20 p-3 rounded-lg">
                        <h5 className="font-semibold text-teal-700 dark:text-teal-300 mb-1">Transparency</h5>
                        <p className="text-sm text-teal-600 dark:text-teal-400">
                          Adjust opacity from 10% to 100% for perfect visibility
                        </p>
                      </div>
                      <div className="bg-cyan-50 dark:bg-cyan-900/20 p-3 rounded-lg">
                        <h5 className="font-semibold text-cyan-700 dark:text-cyan-300 mb-1">Font & Size</h5>
                        <p className="text-sm text-cyan-600 dark:text-cyan-400">
                          Choose font family, size, and color to match your brand
                        </p>
                      </div>
                    </div>
                  </div>
                ...
                <div className="flex items-start space-x-4">
                  <div className="bg-gradient-to-r from-indigo-500 to-blue-600 text-white rounded-full w-10 h-10 flex items-center justify-center text-lg font-bold flex-shrink-0 mt-1">
                    4
                  </div>
                  <div>
                    <h4 className="text-xl font-semibold text-gray-900 dark:text-white mb-3">Preview and Fine-tune</h4>
                    <p className="text-gray-600 dark:text-gray-300 mb-4">
                      Use the live preview to see exactly how your watermark will appear on the document. Make adjustments to position, size, or transparency as needed.
                    </p>
                    <div className="bg-indigo-50 dark:bg-indigo-900/20 p-4 rounded-lg">
                      <p className="text-sm text-indigo-700 dark:text-indigo-300">
                        ⚡ <strong>Real-time Preview:</strong> See changes instantly as you adjust settings. No guesswork - what you see is what you get.
                      </p>
                    </div>
                  </div>
                </div>
                ...
                <div className="flex items-start space-x-4">
                  <div className="bg-gradient-to-r from-purple-500 to-indigo-600 text-white rounded-full w-10 h-10 flex items-center justify-center text-lg font-bold flex-shrink-0 mt-1">
                    5
                  </div>
                  <div>
                    <h4 className="text-xl font-semibold text-gray-900 dark:text-white mb-3">Apply and Download</h4>
                    <p className="text-gray-600 dark:text-gray-300 mb-4">
                      Once you're satisfied with the watermark placement and appearance, click "Apply Watermark" to process all pages and download your protected PDF.
                    </p>
