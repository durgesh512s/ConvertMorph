...
export function ClientBreadcrumb() {
  ...
  useEffect(() => {
    ...
    // Debug logging
    console.log('ClientBreadcrumb - pathname:', pathname);
    console.log('ClientBreadcrumb - generated breadcrumbs:', breadcrumbs);
    console.log('ClientBreadcrumb - final JSON-LD:', JSON.stringify(breadcrumbJsonLd, null, 2));

    // Create and inject the new breadcrumb JSON-LD
